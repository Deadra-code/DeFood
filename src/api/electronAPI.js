...
// Deskripsi: Menambahkan fungsi helper untuk API pengaturan.
...
export const addIngredientToRecipe = (data) => isApiReady() ? window.api.addIngredientToRecipe(data) : Promise.reject(new Error("API not ready"));
